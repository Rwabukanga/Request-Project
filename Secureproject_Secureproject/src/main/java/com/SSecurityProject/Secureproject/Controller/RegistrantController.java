...
import com.SSecurityProject.Secureproject.Domain.Categories;
import com.SSecurityProject.Secureproject.Domain.District;
import com.SSecurityProject.Secureproject.Domain.Gender;
import com.SSecurityProject.Secureproject.Domain.Registrant;
import com.SSecurityProject.Secureproject.Domain.Systemuser;
import com.SSecurityProject.Secureproject.Service.CategoryService;
import com.SSecurityProject.Secureproject.Service.DistrictService;
import com.SSecurityProject.Secureproject.Service.RegistrantService;
			 ...
			 /*  regg.setCategory(reg.getCategory());*/
			  ...
			  /* regg.setRequestexp(reg.getRequestexp());*/
	           ...
	           /* message.setTo(to);
	            ...
	            regservice.sendSimpleMessage(user.getEmailAddress(), "This is your Username:"+" "+user.getUsername(), "Hello this is your Username  :"+" "+user.getUsername() +"   "+"this is Password:"+" "+user.getPassword());
